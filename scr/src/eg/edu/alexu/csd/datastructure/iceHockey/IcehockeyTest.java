...
public class IcehockeyTest {
  ...
  public void testMax() {
    ...
    String[] photo = { "11JGKOWPED4433L1111HOGRTY3HKF1112KJH2ROL2222W3FDB1",
        ...
        "11JGKOWPED4433L1111HOGRTY3HKF1112KJH2ROL2222W3FDB1",
        "11JGKOWPED4433L1111HOGRTY3HKF1112KJH2ROL2222W3FDB1", };
    Point[] expected = { new Point(2, 51), new Point(34, 51), new Point(61, 51),
        new Point(99, 51) };
  ...
  public void test1() {
    ...
    Point[] expected = { new Point(3, 8), new Point(4, 16), new Point(5, 4), new Point(16, 3),
  ...
  public void test2() {
    ...
    String[] photo = { "8D88888J8L8E888", "88NKMG8N8E8JI88", "888NS8EU88HN8EO", "LUQ888A8TH8OIH8",
        "888QJ88R8SG88TY", "88ZQV88B88OUZ8O", "FQ88WF8Q8GG88B8", "8S888HGSB8FT8S8",
        "8MX88D88888T8K8", "8S8A88MGVDG8XK8", "M88S8B8I8M88J8N", "8W88X88ZT8KA8I8",
        "88SQGB8I8J88W88", "U88H8NI8CZB88B8", "8PK8H8T8888TQR8" };
    Point[] expected = { new Point(1, 17), new Point(3, 3), new Point(3, 10), new Point(3, 25),
        new Point(5, 21), new Point(8, 17), new Point(9, 2), new Point(10, 9), new Point(12, 23),
        new Point(17, 16), new Point(18, 3), new Point(18, 11), new Point(18, 28),
        new Point(22, 20), new Point(23, 26), new Point(24, 15), new Point(27, 2),
  ...
  public void test5() {
    ...
    Point[] expected = { new Point(1, 1), new Point(1, 5), new Point(3, 3), new Point(3, 7),
        new Point(5, 1), new Point(5, 5), new Point(7, 3), new Point(7, 7), new Point(9, 1),
        new Point(9, 5), new Point(11, 3), new Point(11, 7), new Point(13, 1), new Point(13, 5),
        new Point(15, 3), new Point(15, 7), new Point(17, 1), new Point(17, 5), };
